<section id="pricing" class="bg-white dark:bg-gray-800">
    <div class="container px-6 py-8 mx-auto">
        <div class="sm:flex sm:items-center sm:justify-between">
            <div>
                <h2 class="text-3xl font-bold text-gray-800 dark:text-gray-100">PRIZE TABLES</h2>
                <p class="mt-4 text-gray-500 dark:text-gray-400">Offers you just cannot miss</p>
            </div>
        </div>
    ...
    <div id="animation-carousel" class="relative" data-carousel="static">
        <!-- Carousel wrapper -->
        <div class="relative overflow-hidden rounded-lg h-96 lg:h-72">
            <!-- Item 1 -->
            <div class="absolute inset-0 hidden transition-all duration-200 ease-linear transform bg-gray-100" data-carousel-item="">
                <div class="lg:w-[1020px] w-full mx-1 mt-2 lg:mt-6 lg:mx-auto">
                    <div class="flex items-center mb-4 space-x-4">
                        <img class="w-10 h-10 rounded-full" src="https://api.lorem.space/image/face?w=150&h=150" alt="">
            ...
            <!-- Item 2 -->
            <div class="absolute inset-0 z-10 transition-all duration-200 ease-linear transform -translate-x-full bg-gray-100" data-carousel-item="">
                <div class="lg:w-[1020px] w-full mx-1 mt-2 lg:mt-6 lg:mx-auto">
                    <div class="flex items-center mb-4 space-x-4">
                        <img class="w-10 h-10 rounded-full" src="https://api.lorem.space/image/face?w=150&h=150" alt="">
                        <div class="space-y-1 font-medium dark:text-white">
            ...
            <!-- Item 3 -->
            <div class="absolute inset-0 z-20 transition-all duration-200 ease-linear transform translate-x-0 bg-gray-100" data-carousel-item="active">
                <div class="lg:w-[1020px] w-full mx-1 mt-2 lg:mt-6 lg:mx-auto">
                    <div class="flex items-center mb-4 space-x-4">
                        <img class="w-10 h-10 rounded-full" src="https://api.lorem.space/image/face?w=150&h=150" alt="">
                        <div class="space-y-1 font-medium dark:text-white">
            ...
            <!-- Item 5 -->
            <div class="absolute inset-0 hidden transition-all duration-200 ease-linear transform bg-gray-100" data-carousel-item="">
                <div class="lg:w-[1020px] w-full mt-2 lg:mt-6 lg:mx-auto">
                    <div class="flex items-center mb-4 space-x-4">
                        <img class="w-10 h-10 rounded-full" src="https://api.lorem.space/image/face?w=150&h=150" alt="">
                        <div class="space-y-1 font-medium dark:text-white">
                            <p>Jese Leos <time datetime="2014-08-16 19:00" class="block text-sm text-gray-500 dark:text-gray-400">Joined on August 2014</time></p>
        ...
        <button type="button" class="absolute top-0 left-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev="">
            <span class="inline-flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-blue-400/70 dark:bg-blue-500/80 group-hover:bg-blue-400/70 dark:group-hover:bg-blue-500/80 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
    ...
    <div class="bg-course">
        <div class="container px-6 py-10 mx-auto">
            <h1 class="my-0 text-3xl font-semibold text-gray-200 uppercase md:my-8 lg:text-4xl dark:text-white">Courses</h1>
            ...
            <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
                <div class="p-8 space-y-3 border-2 border-blue-400 bg-cream-white dark:border-blue-300 rounded-xl">
                    ...
                    <h1 class="text-xl font-semibold text-gray-700 capitalize dark:text-white">How to protect yourself and the car</h1>
    
                    <div class="flex flex-col justify-between text-gray-500 dark:text-gray-300">
                        <div class="my-4"><span>Automatic</span> ................................................... <span>$350</span></div>
                        <div class="mb-4"><span>Mechanics</span> ................................................... <span>$400</span></div>
                    </div>
                ...
                <div class="p-8 space-y-3 border-2 border-blue-400 bg-cream-white dark:border-blue-300 rounded-xl">
                    ...
                    <h1 class="text-xl font-semibold text-gray-700 capitalize dark:text-white">Testing Routes</h1>

                    <div class="flex flex-col justify-between text-gray-500 dark:text-gray-300">
                        <p class="my-4"><span>Automatic</span> ................................................... <span>$350</span></p>
                        <p class="mb-4"><span>Mechanics</span> ................................................... <span>$400</span></p>
                    </div>
                ...
                <div class="p-8 space-y-3 border-2 border-blue-400 bg-cream-white dark:border-blue-300 rounded-xl">
                    ...
                    <h1 class="text-xl font-semibold text-gray-700 capitalize dark:text-white">Eliminating fear and excitement behind wheel</h1>
                ...
                <div class="p-8 space-y-3 border-2 border-blue-400 bg-cream-white dark:border-blue-300 rounded-xl">
                    ...
                    <h1 class="text-xl font-semibold text-gray-700 capitalize dark:text-white">Basic working out the basics of driving</h1>
                ...
                <div class="p-8 space-y-3 border-2 border-blue-400 bg-cream-white dark:border-blue-300 rounded-xl">
                    ...
                    <h1 class="text-xl font-semibold text-gray-700 capitalize dark:text-white">Consultation</h1>
                ...
                <div class="p-8 space-y-3 border-2 border-blue-400 bg-cream-white dark:border-blue-300 rounded-xl">
                    ...
                    <h1 class="text-xl font-semibold text-gray-700 capitalize dark:text-white">Practice skills of communication with traffic police</h1>
